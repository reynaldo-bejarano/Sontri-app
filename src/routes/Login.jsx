        ...
        <div className="h-screen w-screen bg-[#f0f2f5] dark:bg-[#f0f2f5] relative">
            <div className="container mx-auto lg:p-20 2xl:px-10 2xl:py-56">
                <div className="grid lg:grid-cols-5 md:gap-20">
                    ...
                    <div className="lg:col-span-2 md:w-[70%] lg:w-full md:mx-auto bg-[#f0f2f5] dark:bg-[#f0f2f5]">
                        <div className="p-10 bg-white dark:bg-white shadow-lg rounded-lg ">
                            <LoginForm />
                            ...
                            <div className="w-full bg-gray-300 dark:bg-gray-300 h-[1px]"></div>
