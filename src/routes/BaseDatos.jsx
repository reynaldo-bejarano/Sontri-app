                    ...
                    <div className="dark:bg-slate-800 bg-slate-800 w-full md:h-96 lg:h-64 py-14">
                        <div className="w-full">
                            <div className="lg:px-16 px-2">
                                ...
                                <div>
                                    {/* ciclo map */}
                                    <div className="dark:bg-[#334155] bg-[#334155] p-5 rounded-lg mb-4 gap-2 md:flex justify-between ">
                                        <div className='grid gap-1 mb-5 md:mb-0'>
                                            <p className="dark:text-white text-white text-sm  font-bold capitalize">Nicole Retana porras</p>
                                            <div className='flex items-center gap-5'>
                                                <p className="dark:text-white text-white text-sm  font-bold">nicole.retana@uhispano.ac.cr</p>
                                                <button> <FiCopy className='text-white dark:text-white' /></button>
                                            </div>
                                            <p className="dark:text-white text-white text-sm  font-bold">20/10/2022</p>
