                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className='dark:bg-white bg-white h-60 w-full overflow-auto '>
                                        <div>
                                            ...
                                            <div className='grid grid-cols-12 gap-2 w-full  text-sm border-b dark:border-slate-700 border-slate-700 hover:bg-[#ed796c] p-2 '>
                                                <input type="checkbox" className='col-span-1' />
                                                <p className='border-l dark:border-slate-700 border-slate-700 px-1 col-span-5 overflow-hidden'>nicole.retana@uhispano.ac.cr</p>
                                                <p className='border-l border-r dark:border-slate-700 border-slate-700 px-1 col-span-5 overflow-hidden'>Nicole Retana Porras</p>
                                            ...
                                            <div className='grid grid-cols-12 gap-2 w-full  text-sm border-b dark:border-slate-700 border-slate-700 hover:bg-[#ed796c]  p-2 '>
                                                ...
                                                <p className='border-l border-r dark:border-slate-700 border-slate-700 px-1 col-span-5'>Andrea Mora Morales</p>
                                                <button className='col-span-1 mx-auto'>
                                                    <FiCopy />
                                                </button>
                                            </div>
                                            <div className='grid grid-cols-12 gap-2 w-full  text-sm border-b dark:border-slate-700 border-slate-700 hover:bg-[#ed796c]  p-2 '>
                                                <input type="checkbox" className='col-span-1' />
                                                <p className='border-l dark:border-slate-700 border-slate-700 px-1 col-span-5 overflow-hidden'>wilmer.abarca@uhispano.ac.cr</p>
                                                <p className='border-l border-r dark:border-slate-700 border-slate-700 px-1 col-span-5 overflow-hidden'>Wilmer Howard Abarca</p>
                                                <button className='col-span-1 mx-auto'>
                                                    <FiCopy />
                                                </button>
                                            </div>
