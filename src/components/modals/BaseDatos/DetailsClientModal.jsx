            ...
            <div className="p-5 md:px-10 2xl:p-10  shadow-lg rounded-lg">
                ...
                <form className="grid gap-2">
                    <div className="grid md:grid-cols-6 gap-3">
                        <p className="col-span-2 p-2 rounded-lg bg-white dark:bg-white text-gray-600 dark:text-gray-600">Nicole</p>
                        <p className="col-span-2 p-2 rounded-lg bg-white dark:bg-white text-gray-600 dark:text-gray-600">Retana Porras</p>
                    ...
                    <div className="grid grid-cols-6 gap-3">
                        <p className="col-span-2 p-2 rounded-lg dark:bg-white bg-white text-gray-600 dark:text-gray-600">Fecha</p>
                        <p className="col-span-2 p-2 rounded-lg dark:bg-white bg-white text-gray-600 dark:text-gray-600">Intéres 1</p>
                        <p className="col-span-2 p-2 rounded-lg dark:bg-white bg-white text-gray-600 dark:text-gray-600">Intéres 2</p>
                    </div>
