...
dark:bg-[#334155] absolute top-1/4 md:top-1/2 lg:md:top-1/2 md:left-1/2 md:transform 
md:-translate-x-1/2 md:-translate-y-1/2 border-2 dark:border-white">
                <div className="p-5 md:px-10 2xl:p-10  shadow-lg rounded-lg">
                    ...
                    <div className=" h-96 overflow-auto">
                        {/* map */}
                        <p className="p-2 mb-2  rounded-lg h-10 bg-white flex justify-between items-center"
