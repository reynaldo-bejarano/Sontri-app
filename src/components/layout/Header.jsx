                        ...
                        <ul className="list-reset flex justify-between flex-1 md:flex-none items-center">
                            <li className="flex-1 md:flex-none md:mr-3">
                                <div className="relative inline-block">
                                    ...
                                    <div
                                        id="myDropdown"
                                        className={userModalIsOpen ? "dropdownlist absolute bg-slate-700 text-slate-800 right-0 mt-3 p-3 overflow-auto z-30 w-[150px]" : "hidden"}

                                    >

                                        <NavLink
                                            to="/cuenta"
                                            className="p-2  text-white text-sm no-underline hover:no-underline block"
                                        >
                                            Mi cuenta
                                        </NavLink>
                                        <NavLink
